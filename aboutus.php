...
<body>
    ...
    <div class="box">
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
        <tr>
          <td style="color:green"><h1 align="center"><marquee><i>Welcome To Rajender Royal Library</i>  </marquee></h1></td>
        </tr>
        <tr>
...
:30%;background:rgba(0, 0, 0, 0.5);box-shadow:0px 0px 20px #fc7af7;border-radius:10px;padding:3%;font-size:15px;height:200px;"><marquee direction="up" scrolldelay="200" >
        ...
        <div  style="background-color:red; border:solid 2px orange;border-radius: 10px; width:84%; height:40px; margin-left:10%; margin-top:15px" >
