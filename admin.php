...
<body>
    ...
    <div class="box">
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
        <tr>
            <td style="color:white"><h1 align="center"><marquee><i>Welcome To Rajender Royal Library </i>  </marquee></h1></td></tr>
        <tr>
          <td align="center"><b><i><mark style="color:white;background-color:maroon";>ADMIN </mark></i></b></td>
        </tr>
      </table>
    </div>
...
<!--    <input type="text" placeholder="search by book id"><button type="button">search</button>  -->
   ...
   <div class="main">
       ...
       <table>
        ...
        <div  style="background-color:red; border:solid 2px orange;border-radius: 10px; width:84%; height:40px; margin-left:9%; margin-top:15px" >
