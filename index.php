...
body{
  ...
  .box{
    ...
    background-image: url("lib12.jpeg");
...
<body>
  <div class="box">
   <table  style =" font-size:16pt"  align="center" width="100%" height="100%" >
      <tr>
        <td style="color:green"><h1 align="center"><marquee><u>Welcome To Rajender Royal library</u></marquee></td></h1>
      </tr>
      <tr>
    ...
    <form method="post" action="">
      <div  class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:73.5%; height:360px; margin-left:13%;margin-top:15px;background-color:white">
        ...
        <fieldset align="center" style="  background:rgba(0,0,0,0.38);color:red;" class="five" class="one">
          <div class="boxfour">
        ...
        <table style="font-size:16pt;width:300px;height:50px;margin-right:45px;" align="Right">
          ...
          <tr>
            ...
            <td style="font-size:20pt"><a href="registration.php" style="color:red">Register Now</a></td>
          </tr>
          <tr>
            <td ><br></td>
            <td><br></td>
    ...
    <div class="boxthree" style="background-color:red; border:solid 2px orange;border-radius: 10px; width:73.5%; height:40px; margin-left:13%; margin-top:15px" >
      <marquee><h6 style="line-height:1px;">Thank You </h6></marquee>
