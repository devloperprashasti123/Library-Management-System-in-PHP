  ...
  <body>
    <div class="box">
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
        <tr>
          <td style="color:white"><h1 align="center"><marquee><i>Welcome To Rajender Royal Library </i>  </marquee></h1></td>
        </tr>
        <tr>
  ...
  <div class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:84%; height:360px; margin-left:0%;margin-top:10px;background-color:white">
    ...
    <table width="100%" height="310px" border="1"  align="center" style="color:white;  background:rgba(0,0,0,0.38);box-shadow:0px 0px 15px lightblue;">
      <tr>
        ...
        <div  style="background-color:red; border:solid 2px orange;border-radius: 10px; width:84%; height:40px; margin-left:0%; margin-top:15px" >
          <p ><h6 style="line-height:1px;">Thank You </h6></p>
